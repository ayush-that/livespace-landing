...
export default function Footer() {
  return (
    <div className="mx-0.5 sm:mx-8 lg:mx-20 mb-4 sm:mb-8">
      <footer className="bg-[#1E1E1E] text-white rounded-[20px] sm:rounded-[32px]">
        <div className="w-full max-w-7xl mx-auto p-6 sm:p-8 md:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                />
                <button className="bg-[#FF8A9B] text-white px-6 py-3 rounded-xl hover:bg-[#FF8A9B]/90 transition-colors sm:w-auto w-full max-w-xs">
                  Contact us
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="space-y-4">
                <h3 className="font-medium mb-4 sm:mb-6">Contact Us</h3>
              ...
              {/* Location */}
              <div className="space-y-4">
                <h3 className="font-medium mb-4 sm:mb-6">Location</h3>
                <p className="text-gray-400">
                  483020, Dubai,
                  <br />
          ...
          {/* Bottom Section */}
          <div className="flex flex-col md:flex-row justify-center md:justify-between items-center gap-6 md:gap-8 mt-12 md:mt-16 pt-6 md:pt-8 border-t border-gray-800">
            {/* Logo */}
            <Image
              src="/footer/logo.svg"
              alt="LiveSpace Logo"
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
              <span className="text-gray-400 mb-2 sm:mb-0 sm:mr-2">Socials</span>
